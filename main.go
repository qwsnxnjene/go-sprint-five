...
func (w Walking) Calories() float64 {
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(KmHInMsec*w.meanSpeed(), 2.0)/(w.Height/100.0))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
